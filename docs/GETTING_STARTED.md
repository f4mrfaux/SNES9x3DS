...
## Debugging on 3DS Hardware

Once you have your build running on the 3DS, you'll need to debug issues. See the comprehensive debugging guide:

**[3DS Debugging Guide](3DS_DEBUGGING_GUIDE.md)**

### Quick Debug Tips

**On-screen console output (easiest):**
- The bottom screen shows `printf()` output
- Look for `[MAIN-RENDER]` and `[DUAL-RENDER]` messages
- Take a photo with your phone to capture logs

**Luma3DS Rosalina debugger (advanced):**
- Press **L + Down + Select** in-game to open Rosalina menu
- Enable debugger and note IP address
- Connect with GDB: `arm-none-eabi-gdb` → `target remote <IP>:4003`

**See full guide:** `docs/3DS_DEBUGGING_GUIDE.md`

---

**Last Updated:** 2025-11-13
**Status:** Development Environment Setup Guide with Debugging
